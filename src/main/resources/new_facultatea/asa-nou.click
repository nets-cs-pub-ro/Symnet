...
ps :: PaintSwitch();
cl_incoming :: IPClassifier( dst host 141.85.225.151 and dst tcp port 21, dst host 141.85.225.151 and dst tcp port 80, dst host 141.85.225.151 and dst tcp port 5000, dst host 141.85.225.151 and dst tcp port 5001, dst host 141.85.225.151 and dst tcp port 443, dst host 141.85.225.152 and dst tcp port 22, dst host 141.85.225.153,-);
	global_nat[0] -> [0]pn_0;
				...
				unstatic_rw[0] -> [0]ps;
					ps[0] -> [0]cl_incoming;
						cl_incoming[0] -> [0]dest_clp;
							dest_clp[0] -> [0]out_etherEncap_LABS_CS;
	...
	global_nat[1] -> [0]just_pass_paint;
		just_pass_paint[0] -> [0]dest_cl;
			...
			dest_cl[1] -> [0]outside_ether_encap;
